  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section id="contact" className="section-rule bg-background py-24 sm:py-32"><div className="mx-auto max-w-7xl px-5 sm:px-8"><div className="glass overflow-hidden rounded-[2rem] p-7 sm:p-12 lg:p-16"><div className="grid gap-12 lg:grid-cols-[1fr_auto] lg:items-end"><div><p className="font-mono text-xs uppercase tracking-[0.2em] text-primary">07 / CONTACT</p><h2 className="mt-5 max-w-2xl text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl">Let&apos;s turn data into meaningful insights.</h2><p className="mt-6 max-w-xl text-lg leading-8 text-muted-foreground">I&apos;m actively looking for Data Analyst opportunities where I can contribute from day one — SQL/MySQL analysis, Python programming, Power BI and Excel dashboards, and data-driven problem solving. Whether it&apos;s a full-time role, an internship, or a conversation about data, I&apos;d love to hear from you.</p></div><a href="mailto:mahendramahe689@gmail.com" className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-sm font-bold text-primary-foreground transition-transform hover:-translate-y-0.5">Email Me <ArrowUpRight size={17} /></a></div><div className="mt-12 grid gap-4 border-t border-border pt-8 sm:grid-cols-3"><a href="mailto:mahendramahe689@gmail.com" className="group"><p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">Email</p><p className="mt-2 break-all text-sm font-semibold text-foreground group-hover:text-primary">mahendramahe689@gmail.com</p></a><a href="tel:+916302777658" className="group"><p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">Phone</p><p className="mt-2 text-sm font-semibold text-foreground group-hover:text-primary">6302777658</p></a><a href={linkedInUrl} target="_blank" rel="noopener noreferrer" className="group"><p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">Professional profile</p><p className="mt-2 inline-flex items-center gap-2 text-sm font-semibold text-foreground group-hover:text-primary"><Linkedin size={16} className="text-primary" /> LinkedIn</p></a></div></div></div></section>
      </main>
