...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Galla Mahendra | Data Analyst Portfolio" },
      { name: "description", content: "Portfolio of Galla Mahendra featuring data analytics projects, Python, SQL, Power BI, Excel, AI & DS, internships, and certifications." },
      { property: "og:title", content: "Galla Mahendra | Data Analyst Portfolio" },
      { property: "og:description", content: "Explore Galla Mahendra's projects, analytics skills, internships, education, and certifications." },
      ...
      <main>
        <section id="home" className="hero-wash data-grid relative overflow-hidden pt-32 sm:pt-40">
          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-14 px-5 pb-20 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8 lg:pb-28">
            <div className="animate-reveal-up">
              ...
              <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground">A Computer Science (AI &amp; DS) graduate who turns raw, messy data into clear insights, interactive dashboards, and intelligent solutions. I bring hands-on experience across the full analytics workflow — from writing complex SQL queries and Python preprocessing to building Power BI and Excel dashboards that make business performance easy to read at a glance.</p>
        ...
        <section id="about" className="section-rule bg-background py-24 sm:py-32">
          <div className="mx-auto grid max-w-7xl gap-14 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
            ...
            <div>
              <p className="max-w-3xl text-lg leading-8 text-muted-foreground">Computer Science (AI &amp; DS) undergraduate with hands-on experience in Python, SQL, Power BI, and Advanced Excel through a six-month data analytics internship and a portfolio of analytics projects spanning healthcare, retail, and sales intelligence. Skilled in data cleaning, exploratory data analysis, dashboard development, and machine learning fundamentals, with practical exposure to complex SQL queries and interactive Power BI/Excel dashboards. Certified in data analytics and visualization through Deloitte, Accenture, and SmartBridge.</p>
              <p className="mt-6 max-w-3xl text-base leading-8 text-muted-foreground">What sets me apart is range: I can query a 9,994-row database with advanced SQL, preprocess and model data in Python, and then present the results as a polished, interactive dashboard a manager can act on. I&apos;m looking for a Data Analyst role where analytical thinking, attention to detail, and clear communication turn everyday business data into better decisions.</p>
